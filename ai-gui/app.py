...
class StreamlitApp:
   ...
   #     return self.model
    ...
    def construct_app(self):
        ...
        st.write("Predicted no. of retweets:",self.model.predict(np.array([date_conv,int(fav),sent]).reshape(1,-1))) #to run input with the model
